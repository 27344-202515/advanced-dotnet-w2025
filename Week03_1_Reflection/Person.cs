...
namespace Week03_1_Reflection
{
    public class Person
    {
        ...
        static Person()
        {
            Console.WriteLine("Static Person constructor was invoked.");
        }

        public Person()
        {
            Names = new List<Name>();
            Console.WriteLine("Default Person constructor was invoked.");
        }

        public Person(string name)
        {
            Names = new List<Name>();
            Console.WriteLine("Parameterized Person constructor was invoked.");
        }
